...
🌐 **Portfolio:** https://charleschristianv2.netlify.app/
...
- Architected scalable ERP systems using React.js, Next.js, TypeScript, Zustand, and TanStack Query.
- Integrated Laravel REST APIs via Axios for real-time business workflows.
- Led frontend architecture and implementation for commercial ERP solutions.
- Established scalable frontend patterns that improved maintainability and team productivity.
...
**Information and Communication Technology (Animation)**  
...
- 🌱 Learning Docker, Kubernetes, GitHub Actions, and DevOps practices
